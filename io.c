/* --------------------------------------------------------------------------- */
///										 */
/// Communication and handling of IO devices													///
///										 */
/* --------------------------------------------------------------------------- */
///										 */
/// By Panos Varelas <varelaspanos@gmail.com>													///
///										 */
/// Subroutines handling the PS2 protocol are based on code written by ATMEL staff				///
/// for the ICCA90 C-compiler (application note "313:Interfacing the PC AT Keyboard")			///
///										 */
/* --------------------------------------------------------------------------- */
