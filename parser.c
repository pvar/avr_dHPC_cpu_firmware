...
// other keywords
const uint8_t to_tab[3] PROGMEM = { 'T', 'O' + 0x80, 0 };
const uint8_t step_tab[5] PROGMEM = { 'S', 'T', 'E', 'P' + 0x80, 0 };
const uint8_t highlow_tab[12] PROGMEM = { 'H', 'I', 'G', 'H' + 0x80, 'H', 'I' + 0x80, 'L', 'O', 'W' + 0x80, 'L', 'O' + 0x80, 0 };
